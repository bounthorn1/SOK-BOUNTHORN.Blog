    ...
    <footer className="border-t border-warm-200 dark:border-warm-800 mt-20">
      <div className="max-w-6xl mx-auto px-5 sm:px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display text-sm font-semibold text-ink dark:text-warm-300">Copyright © 2026 BOUNTHORN. All rights reserved.</span>
          <span className="text-xs text-ink-faint dark:text-warm-300 ml-2">A space for stories.</span>
        </div>
