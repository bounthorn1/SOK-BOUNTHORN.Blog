...
const DIFFERENT_ITEMS = [
  ...
  { Icon: PaletteIcon, title: 'បទពិសោធន៍អានដ៏ល្អផូរផង', desc: 'អក្សររចនាស្អាត ប្លង់ដែលបានគិតគូរ និងគ្មានភាពរំខាន។ ការអាននៅលើ ប៊ុនថនប្លុក មានអារម្មណ៍ដូចជាកំពុងកាន់សៀវភៅដែលបានផលិតយ៉ាងប្រណិត' },
            ...
            <RevealSection delay={150}>
              <div>
                ...
                <div className="space-y-4 text-gray-500 dark:text-slate-400 leading-relaxed text-sm sm:text-base">
                  <p>ប៊ុនថនប្លុក បានកើតឡើងពីជំនឿដ៏សាមញ្ញមួយ៖ នៅក្នុងពិភពលោកដែលផ្តោតលើល្បឿន និងភាពល្បីភ្លាមៗ គួរតែមានកន្លែងមួយដែលការសរសេរអាចដកដង្ហើមបាន។ កន្លែងដែលរឿងរ៉ាវមិនចាំបាច់ប្រកួតប្រជែងដើម្បីទទួលបានការយកចិត្តទុកដាក់ — វាត្រឹមតែត្រូវការភាពពិតប៉ុណ្ណោះ</p>
                  ...
                  <p>សព្វថ្ងៃ ប៊ុនថនប្លុក គឺជាសហគមន៍កំពុងរីកចម្រើននៃអ្នកសរសេរ និងអ្នកអាន ដែលជឿថារឿងរ៉ាវល្អបំផុតមិនមែនជារឿងដែលមានសំឡេងខ្លាំងបំផុតទេ — តែជារឿងដែលស្មោះត្រង់បំផុត។ យើងមិនតាមដាននិន្នាការ។ យើងមិនបង្កើនប្រសិទ្ធភាពសម្រាប់អាល់ហ្គូរីធម៍ទេ។ យើងសរសេរអ្វីដែលមានអត្ថន័យពិតប្រាកដ​ ។.</p>
                </div>
        ...
        <div className="max-w-3xl mx-auto px-5 sm:px-8">
          <RevealSection>
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 dark:text-slate-400 text-sm sm:text-base leading-relaxed">ពីកំណត់ហេតុផ្ទាល់ខ្លួន ទៅកាន់សហគមន៍កំពុងរីកចម្រើន — នេះជារឿងរ៉ាវរបស់ ប៊ុនថនប្លុក ជាប្រការទៅមួយប្រការ</p>
            </div>
          </RevealSection>
          <div className="relative">
        ...
        <section className="relative py-16 sm:py-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-8 text-center">
            ...
            <blockquote className="font-display text-xl sm:text-2xl lg:text-3xl font-bold text-white leading-snug mb-6">
              "ប៊ុនថនប្លុក គឺជាប្លក់តែមួយគត់ដែលខ្ញុំអាន ហើយខ្ញុំមានអារម្មណ៍ថាអ្នកសរសេរពិតជាយកចិត្តទុកដាក់ចំពោះអ្វីដែលពួកគេកំពុងនិយាយ រាល់អត្ថបទធ្វើឲ្យខ្ញុំគិតបន្តរយៈពេលជាច្រើនថ្ងៃ"
            </blockquote>
      ...
      <section className="bg-white dark:bg-slate-900 py-16 sm:py-24">
        <div className="max-w-3xl mx-auto px-5 sm:px-8">
          ...
          <div className="space-y-4">
            {[
              { q: 'តើអ្នកណាក៏អាចសរសេរឲ្យ ប៊ុនថនប្លុក បានទេ?', a: "បាទ យើងស្វាគមន៍ការផ្ញើអត្ថបទពីគ្រប់គ្នា។ មិនថាអ្នកជាអ្នកសរសេរដែលមានបទពិសោធន៍ ឬកំពុងចែករំលែករឿងរ៉ាវដំបូងរបស់អ្នកទេ យើងពិនិត្យរាល់អត្ថបទដោយការយកចិត្តទុកដាក់ និងការគោរពដូចគ្នា ។" },
              { q: 'តើវាពិតជាឥតគិតថ្លៃមែនទេ?', a: 'ពេញលេញ។ គ្មានការបិទខ្ទប់ការចូលប្រើ គ្មានកម្រិតសេវាពិសេស (premium tiers) គ្មានល្បិច “សាកល្បងឥតគិតថ្លៃ” ទេ។ រាល់រឿងរ៉ាវនៅលើ ប៊ុនថនប្លុក អាចអានបានដោយសេរី ជានិច្ច — បានតែងតែជាដូច្នេះ និងនឹងនៅតែជាដូច្នេះជានិច្ច' },
              ...
              { q: 'តើខ្ញុំអាចគាំទ្រ ប៊ុនថនប្លុក ដោយរបៀបណា?', a: 'វិធីល្អបំផុតគឺការអាន ចែករំលែករឿងរ៉ាវដែលអ្នកស្រឡាញ់ និងពិចារណាសរសេររឿងរបស់អ្នកផ្ទាល់។ ការប្រាប់បន្តពីមាត់មួយទៅមាត់មួយ គឺជាខ្សែជីវិតសំខាន់របស់ការបោះពុម្ពផ្សាយឯករាជ្យ' },
            ].map((faq, i) => (
